...
function import_product($product)
{
	...
	// Holger, dann wollen wir mal die Funktionen von Shopware 3.5 nutzen ...
	// actindo bietet keinen Schalter für nachfolgende Eigenschaften an,
	// mit 1 werden sie für alle Artikel aktiviert, mit 0 für alle deaktiviert
//echo print_r($data);
//echo "|".$product['shop']['art']['products_date_available']."|";
//exit();

	/*
	  $somecontent = print_r($product['shop']['attributes']['combination_advanced']['2264-grn-M']['shop']['art']['products_ean'],TRUE);
	  ...
	  echo "Success, wrote to file ($filename)";fclose($handle);
